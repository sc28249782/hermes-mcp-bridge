...
Bridge: `hermes-mcp-bridge-v0.4.0`  
...
ชุดทดสอบครอบคลุม Hermes lifecycle/recovery/model/usage เดิม, Codex allowlist/symlink/sandbox/write approval และ MCP SDK stdio integration ที่ค้นพบ 16 tools
