# Validation plan — v0.5.0 (2026-09-20)
...
- MCP stdio integration covers initialization, discovery of 17 tools, diagnostics, model discovery, model-aware submission, usage tools, polling, output retrieval and foreign run rejection.
- Codex tests cover audit redaction/rotation and recovery visibility after a bridge restart.
