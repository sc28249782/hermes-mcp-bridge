# Hermes MCP Bridge v0.4.0 — Hermes + Codex/WSL2 / ChatGPT
...
```text
/home/somchaip/hermes-mcp-bridge-v0.4.0/
```
...
cd /home/somchaip/hermes-mcp-bridge-v0.4.0
bash install.sh
```
...
ควรค้นพบ 16 เครื่องมือ (Hermes 10 + Codex 6):
...
16 Hermes core tests, 7 Codex permission/process tests, 1 MCP stdio integration test และ 2 tunnel script tests รวม 26 tests; ไม่มี test ใดใช้ model จริง
